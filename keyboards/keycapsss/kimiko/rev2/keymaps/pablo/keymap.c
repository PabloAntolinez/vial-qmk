 ...
 */
 [_QWERTY] = LAYOUT(
    ...
    KC_LCTL, KC_Z,  KC_X,    KC_C,    KC_V,    KC_B,    XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT_T(KC_ENT),
                             XXXXXXX, KC_LGUI, KC_LALT,  KC_ENT,   LOWER,    RAISE,  KC_SPC,   KC_BSPC, XXXXXXX, XXXXXXX
),
/* LOWER
* QWERTY
 * ,--------------------------------------------.                                   ,----------------------------------------------.
